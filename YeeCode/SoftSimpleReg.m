...
%adding grating inclusion
epi{1}(125:150,100:95)= c_eps_0*11.3;
epi{1}(125:150,60:130)= c_eps_0*11.3; 
epi{1}(125:150,60:50)= c_eps_0*11.3;
...
% BC used to set the boundaries
bc{1}.NumS = 1;
bc{1}.s(1).xpos = nx{1}/(4) + 1;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;
%inclusion add on boundary
bc{1}.NumS = 2;
bc{1}.s(1).xpos = 150;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;
